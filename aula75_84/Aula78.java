...
public class Aula78 {
	...
	public static void main(String[] args) {
		...
		System.out.println("ola == ola3 " + (ola == ola3));//compara a referência de memória
		
		System.out.println("ola == ola4 " + (ola == ola4));//O java atribui num pool de memória as váriaveis simples strings criadas e quando estancia cria um novo espaço de memória
		...
		String ana = "ana";
		String ban = "ban";
		//string vn = "teste"; string com letra maiúscula não é possível utilizar pois a String é uma classe utilitária do Java e string não é, nem tipo primitivo
